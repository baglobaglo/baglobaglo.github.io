...
function setup() {
  ...
  bubble2 = new Bubble(50, 160, 50); //time date
  bubble4 = new Bubble(50, 240, 50); //nighinfo
  bubble5 = new Bubble(50, 320, 50); // todo list
  bubble6 = new Bubble(50, 400, 50); // color, light source
